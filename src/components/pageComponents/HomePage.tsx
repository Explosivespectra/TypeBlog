...
const HomePage: React.FC = () => {
    return (
        <div>
            <p style={{fontSize: "5rem"}}>Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
            <p style={{fontSize: "5rem", fontFamily: "Genshin"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur quod quibusdam
            ...
            Excepturi ea corporis molestiae nesciunt nobis cupiditate rem quod, fuga veritatis deserunt ratione voluptatum incidunt cum. Cumque.</p>
        </div>
    );
}
